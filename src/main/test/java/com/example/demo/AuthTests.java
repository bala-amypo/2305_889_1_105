...
//             l.setId(500L);
//             l.setCheckInTime(LocalDateTime.now());
//             l.setAccessGranted(true);
//             return l;
//         });
...
//         VisitLog vl = new VisitLog(); vl.setId(300L); vl.setCheckOutTime(LocalDateTime.now());
...
//         // ensure status starts as default value from entity
//         assertEquals(a.getStatus(), "SCHEDULED");
